...
app.controller(
  "TaskController",
  function ($scope, CorrectAnswerService, $templateCache, $http) {
    var templates = [
      /* Task group 1 */
    ...
    $scope.changeTaskDifficultySelection = function (taskID) {
      ...
      for (var taskGroup in taskGroupsByDifficulty[experienceLevel]) {
        if (taskGroupsByDifficulty[experienceLevel].hasOwnProperty(taskGroup)) {
          ...
          if (
            taskGroupsByDifficulty[experienceLevel][taskGroup].includes(taskID)
          ) {
    ...
    $scope.tasks = [
      ...
      {
        id: "V2C2",
        templateUrl: "app/angularjs/tasks/CompilerTasks/V2C2.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "V1C3",
        templateUrl: "app/angularjs/tasks/CompilerTasks/V1C3.html",
        isCompleted: false,
        status: "not_answered",
      },
      ...
      {
        id: "L1C1",
        templateUrl: "app/angularjs/tasks/GapTasks/L1C1.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "L3C1",
        templateUrl: "app/angularjs/tasks/FlowchartTask/L3C1.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "L5C1",
        templateUrl: "app/angularjs/tasks/FreeTextTasks/L5C1.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "L2C2",
        templateUrl: "app/angularjs/tasks/CompilerTasks/L2C2.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "L4C2",
        templateUrl: "app/angularjs/tasks/CompilerTasks/L4C2.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "L2C3",
        templateUrl: "app/angularjs/tasks/CompilerTasks/L2C3.html",
        isCompleted: false,
        status: "not_answered",
      },
      ...
      {
        id: "F1C1",
        templateUrl: "app/angularjs/tasks/GapTasks/F1C1.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "F1C2",
        templateUrl: "app/angularjs/tasks/CompilerTasks/F1C2.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
        id: "F5C2",
        templateUrl: "app/angularjs/tasks/CompilerTasks/F5C2.html",
        isCompleted: false,
        status: "not_answered",
      },
      {
      ...
      {
        id: "F2C3",
        templateUrl: "app/angularjs/tasks/CompilerTasks/F2C3.html",
        isCompleted: false,
        status: "not_answered",
      },
    ];
    ...
    $scope.prevTask = function () {
      if ($scope.currentTaskIndex > 0) {
        ...
        var taskGroups = Object.keys(
          taskGroupsByDifficulty[$scope.selectedExperienceLevel]
        );
        for (var i = 0; i < taskGroups.length; i++) {
          if (
            taskGroupsByDifficulty[$scope.selectedExperienceLevel][
              taskGroups[i]
            ].includes($scope.currentTask.id)
          ) {
    ...
    $scope.nextTask = function () {
      if ($scope.currentTaskIndex < $scope.tasks.length - 1) {
        ...
        for (
          var i = $scope.currentTaskIndex + 1;
    ...
    $scope.selectNextTaskBasedOnDiff = function (nextTaskID, experienceLevel) {
      // Durchsuchen der Aufgaben in der aktuellen Schwierigkeitsstufe
      for (var taskGroup in taskGroupsByDifficulty[
        $scope.selectedExperienceLevel
      ]) {
        if (
          taskGroupsByDifficulty[$scope.selectedExperienceLevel].hasOwnProperty(
            taskGroup
          )
        ) {
          // Überprüfen, ob die aktuelle Aufgabe in der Gruppe enthalten ist
    ...
    $scope.calculateProgress = function (taskID, difficultyChange) {
      ...
      if (difficultyChange == 1) {
        ...
        var completedTasks = $scope.tasks.filter(function (task) {
          return (
            task.status === "correct" &&
            $scope.changeTaskDifficultySelection(task.id)
          );
        }).length;
        ...
        var completedTasks = $scope.markTaskAsCompleted(
          solvedTasks,
          experienceLevel
        );
